---
title: Stagehand
description: Give Deep Agents persistent browser automation tools using Stagehand, locally or in a managed deployment.
---

[Stagehand](https://stagehand.dev) is an open-source browser automation framework built on top of Playwright. The Stagehand integration gives Deep Agents two AI-powered browser tools — `run`, `snapshot`, and `screenshot` — available through either a local MCP server or as native Python tools in a Managed Deep Agent deployment.
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/deepagents/stagehand.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
